...
@Data public class WeatherResponse {
    private String name; private Main main; private Wind wind; private List<Weather> weather; private Coord coord;
    @Data public static class Main { private Double temp; private Double humidity; private Double pressure; }
